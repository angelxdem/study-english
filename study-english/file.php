...
?>
        <form method="post">
            ...
            <select id="english_level" name="english_level">
                <option value="Beginner" <?php if ($profile["english_level"] == "Beginner") {
    echo "selected";
} ?>>Beginner</option>
                <option value="Intermediate" <?php if ($profile["english_level"] == "Intermediate") {
    echo "selected";
} ?>>Intermediate</option>
                <option value="Advanced" <?php if ($profile["english_level"] == "Advanced") {
    echo "selected";
} ?>>Advanced</option>
            </select>
